...
/// The console's one table, ported from QuartzFire: a search box and drop-down
/// filters over the top, sortable headers the operator can hide, reorder, and
/// drag to resize, click/shift/ctrl row selection, and a row count. The layout
/// is remembered per `storageKey`, so an arrangement survives a reload.
