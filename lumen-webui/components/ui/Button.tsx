...
/// The console's one button, ported from QuartzFire so both products' toolbars
/// are the same control. A disabled button carries no tooltip of its own —
/// wrap it in a `<span title="…">` when the reason it is off needs saying.
